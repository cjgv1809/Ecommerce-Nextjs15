  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-80 lg:sticky lg:top-4 h-fit bg-white p-6 border rounded order-first lg:order-last fixed bottom-0 left-0 lg:left-auto shadow-md">
          ...
          {isSignedIn ? (
            ...
            <SignInButton mode="modal">
              <button className="mt-4 w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">
                Sign in to checkout
              </button>
            </SignInButton>
          )}
